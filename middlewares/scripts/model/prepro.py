...
rfecolname_X=['src_bytes', 'dst_bytes', 'num_compromised', 'count', 'diff_srv_rate', 'dst_host_srv_count', 'dst_host_same_srv_rate', 'dst_host_diff_srv_rate', 'dst_host_same_src_port_rate', 'dst_host_serror_rate', 'service_ecr_i', 'service_ftp_data', 'service_http']
rfecolindex_X=list(newdf_X.columns.get_loc(c) for c in rfecolname_X if c in colNames)

sc=load('std_scaler.bin')
newdf_X = sc.transform(newdf_X)

X_test2=newdf_X[:,rfecolindex_rand]
X_testdecision=newdf_X[:,rfecolindex_X]
